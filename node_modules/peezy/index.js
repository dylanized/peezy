...
// module init
	...
	peezy.init = function(app_config) {
		...
		// init logger
		if (app_config.level) peezyLogger.level = app_config.level;
		else if (process.env.NODE_ENV && process.env.NODE_ENV == "production") peezyLogger.level = 0;
