// module setup
	...
	var	fileHelper = require("peezy-file-helper"),
		peezyLogger = require("peezy-logger"),
...
// module init
	...
	peezy.init = function(app_config) {
		...
		if (args[0]) app_config.siteFolder = args[0];
		if (args[1]) app_config.themeOverride = args[1];
	
		// init logger
		if (app_config.level) peezyLogger.set(app_config.level);
		else if (process.env.NODE_ENV && process.env.NODE_ENV == "production") peezyLogger.set("silent");
