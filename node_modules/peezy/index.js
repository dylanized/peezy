...
// module init
	...
	peezy.init = function(app_config, cb) {
		...
		// load content and themes
			...
			themeEngine.init(app_config, site_config);
		...
		// routing
			...
			router.get("/", function(req, res) {
				// render homepage
			    renderTemplate(200, site_config.homepage, req, res);
			});
			...
			router.get(/^\/((?:[^\/]+\/?)+)\/?/, function(req, res) {					
				...
				renderTemplate(200, slug, req, res);
			...
			app.use(function(req, res){
				// render error page
				renderTemplate(404, site_config.error, req, res);
			});				
		...
		// functions
			...
			function renderTemplate(status, slug, req, res) {
			...
			function getContent(slug) {
				...
				var filepath = path.join(paths.contentBase, slug);
				var error = path.join(paths.contentBase, site_config.error);
