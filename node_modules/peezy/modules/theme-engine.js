...
// set theme vars
	...
	ThemeEngine.set = function(slug, content, query) {
		...
		this.buildLocals(locals);			
	
	}	
	
// set status

	ThemeEngine.setStatus = function(slug) {
		
		if (!this.pages[slug]) slug = this.siteConfig.error;
		
		if (slug == this.siteConfig.error) this.status = 404;
